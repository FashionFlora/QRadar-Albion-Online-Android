...
public class HarvestingActivity extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        fishingZone = findViewById(R.id.fishingZone);
        ...
        fishingZone.setChecked(RadarSettings.getInstance().harvestingZoneFishing);
        ...
        hide.setOnCheckedChangeListener((compoundButton, b) ->
        {
            ...
            RadarSettings.getInstance().updateHarvestableType(Arrays.asList(
                    ...
                    HarvestableType.HIDE_HIGHLAND), b);
        });

        fishingZone.setOnCheckedChangeListener((compoundButton, b) ->
        {
