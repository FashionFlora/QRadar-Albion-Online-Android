...
import com.minhui.vpn.PhotonPackageParser.classes.PhotonPacket;
...
public class FirewallVpnService extends VpnService implements Runnable {
    ...
    public static String convertBytesToPrintable(byte[] byteArray) {
    ...
    public  String getAlbionPackage()
    {
        selectPackage = "com.albiononline";
        ...
        String searchTerm = "albion";
        for (ApplicationInfo app : apps) {
            if (app.packageName.toLowerCase().contains(searchTerm.toLowerCase())) {


                selectPackage = app.packageName;
                Log.d("selctedPackage" , ""+selectPackage);
            }
        }
       ...
       // Log.d("package",""+selectPackage);
        ...
        try {
            if (selectPackage != null) {
                builder.addAllowedApplication(getAlbionPackage());
